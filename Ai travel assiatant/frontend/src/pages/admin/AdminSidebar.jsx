...
export default function AdminSidebar({
        ...
        <div className="flex flex-col h-full bg-[var(--color-surface)] border-r border-[var(--color-border)] select-none">
            ...
            <div className={`flex items-center justify-between h-16 px-4 border-b border-[var(--color-border)] ${collapsed ? 'justify-center px-2' : ''}`}>
                ...
                <button
                    ...
                    className="hidden lg:flex p-1.5 rounded-lg text-[var(--color-text-muted)] hover:text-[var(--color-text)] hover:bg-[var(--color-soft)] transition"
                ...
                <button
                    ...
                    className="lg:hidden p-1.5 rounded-lg text-[var(--color-text-muted)] hover:text-[var(--color-text)] hover:bg-[var(--color-soft)]"
                >
                    <X className="w-5 h-5" />
                </button>
            </div>
                        ...
                        >
                            ...
                            {isActive && (
                                <motion.div
                                    ...
                                    className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-5 rounded-r-full bg-sky-500"
    ...
    return (
        <>
            ...
            <aside className={`hidden lg:block shrink-0 transition-all duration-300 h-screen sticky top-0 z-30 ${collapsed ? 'w-20' : 'w-64'}`}>
                {sidebarContent}
            </aside>
