...
import { 
    Search, Bell, Moon, Sun, Monitor, Menu, 
    CheckCheck, AlertCircle, ShieldAlert, Sparkles, Database, ExternalLink 
} from 'lucide-react';
...
export default function AdminNavbar({
    ...
    return (
        <header className="sticky top-0 z-20 h-16 bg-[var(--color-surface)]/90 backdrop-blur-md border-b border-[var(--color-border)] px-4 lg:px-6 flex items-center justify-between gap-4">
            {/* Left: Mobile hamburger & Search Shortcut */}
            <div className="flex items-center gap-3 flex-1 max-w-md">
                <button
                    onClick={onOpenMobileSidebar}
                    className="lg:hidden p-2 rounded-xl text-[var(--color-text-muted)] hover:text-[var(--color-text)] hover:bg-[var(--color-soft)] border border-[var(--color-border)]"
                ...
                <button
                    ...
                    className="flex-1 flex items-center justify-between h-10 px-3.5 rounded-xl bg-[var(--color-soft)]/50 hover:bg-[var(--color-soft)] border border-[var(--color-border)] text-xs text-[var(--color-text-muted)] hover:text-[var(--color-text)] transition shadow-inner"
                >
