...
export default function AdminSidebar({
    ...
    const sidebarContent = (
        <div className="flex flex-col h-full bg-[var(--color-surface)] border-r border-[var(--color-border)] select-none shadow-sm">
            {/* Header: Logo & Collapser */}
            <div className={`flex items-center justify-between h-16 px-4 border-b border-[var(--color-border)] ${collapsed ? 'justify-center px-2' : ''}`}>
                ...
                <button
                    ...
                    className="hidden md:flex p-1.5 rounded-lg text-[var(--color-text-muted)] hover:text-[var(--color-text)] hover:bg-[var(--color-soft)] transition"
                ...
                <button
                    ...
                    className="md:hidden p-1.5 rounded-lg text-[var(--color-text-muted)] hover:text-[var(--color-text)] hover:bg-[var(--color-soft)]"
                >
                    <X className="w-5 h-5" />
                </button>
            </div>
            ...
            <div className="flex-1 overflow-y-auto px-3 py-4 space-y-1.5 scrollbar-none">
                <div className="text-[10px] font-bold uppercase tracking-wider text-[var(--color-text-muted)] px-3 mb-2">
                        ...
                        <NavLink
                            ...
                            className={`flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-xs font-semibold transition-all duration-150 relative ${
                                isActive
                                    ...
                                    : 'text-[var(--color-text)]/80 hover:text-[var(--color-text)] hover:bg-[var(--color-soft)]'
                        ...
                        >
                            ...
                            {isActive && (
                                <motion.div
                                    ...
                                    className="absolute left-0 top-1/2 -translate-y-1/2 w-1.5 h-6 rounded-r-full bg-sky-500 shadow-sm"
            ...
            <div className={`p-3 border-t border-[var(--color-border)] bg-[var(--color-soft)]/30 ${collapsed ? 'flex flex-col items-center' : ''}`}>
                <div className="flex items-center justify-between gap-2 p-1.5 rounded-xl hover:bg-[var(--color-soft)] transition">
                ...
                {collapsed && (
                    <button
                        onClick={handleLogout}
                        title="Logout"
                        className="mt-2 p-2 rounded-lg text-[var(--color-text-muted)] hover:text-rose-400 hover:bg-rose-500/10 transition"
                    >
                        <LogOut className="w-4 h-4" />
                    </button>
                )}
